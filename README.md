# An implementation of NECSA on DrQ-v2, an episodic control-based method for solving continuous DMControl tasks with image-based states. Please refer to the repo of DrQ-v2 for installation.
